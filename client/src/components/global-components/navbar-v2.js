				...
				<div className="ltn__header-top-area d-none">
					...
					<div className="row">
						...
						<div className="ltn__top-bar-menu">
							<ul>
							<li><a href="mailto:info@heredia-point.com.ar"><i className="icon-mail" /> info@webmail.com</a></li>
				...
				<div className="ltn__header-middle-area ltn__header-sticky ltn__sticky-bg-white">
					...
					<div className="row">
						...
						<div className="site-logo-wrap">
							...
							<Link to="/">
								<img src={process.env.REACT_APP_SERVER_URL+"/assets/e7904a16-20bf-40b8-bb75-ab52ef09a1f7?height=80"} alt="Logo" />
							</Link>
							</div>
						...
						<div className="header-menu d-none d-xl-block go-top">
							...
							<div className="ltn__main-menu">
								<ul className="justify-content-end">
                                    ...
                                    <li className="menu-icon"><Link to="/shop-grid">Propiedades</Link></li>
